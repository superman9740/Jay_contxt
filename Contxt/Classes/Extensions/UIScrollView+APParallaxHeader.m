...
- (void)addParallaxGestureRecognizer:(UIGestureRecognizer *)gestureRecognizer
{
    if( self.parallaxView && self.parallaxView.imageView )
    {
        self.parallaxView.imageView.userInteractionEnabled = YES;
        [self.parallaxView.imageView addGestureRecognizer:gestureRecognizer];
    }
}

- (void)changeParallaxWithImage:(UIImage *)image
{
